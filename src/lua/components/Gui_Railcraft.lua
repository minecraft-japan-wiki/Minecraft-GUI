...
function p.CokeOven(f)
    ...
    local gui = GuiUtils.new({
        ...
        slots = {
            ...
            { x = 60, y = 36, value = args.output2 or args.target2 or args.slot3 or args[3] }
        },
        images = {
        ...
        tanks = {
            {
                ...
                value = args.output2 or args.target2 or args.tank1 or args.tank or args.slot4 or args[4],
            },
        },
        text = {
            {
...
function p.RockCrusher(f)
    ...
    local gui = GuiUtils.new({
        ...
        slots = {
            ...
            { x = 90,  y = 0,  value = args.output1 or args.target1 or args.input or args.target or args.slot10 or args.D1 or args[10] },
