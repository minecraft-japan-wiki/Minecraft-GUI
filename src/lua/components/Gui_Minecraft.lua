...
function p.Trading(f)
    ...
    if level == "1" or level == "novice" or level == "stone" or level == "V•Ä" then
        level = 1
        levelIcon = "Profession level stone.png"
        levelName = "V•Ä"
    elseif level == "2" or level == "apprentice" or level == "iron" or level == "Œ©K‚¢" then
        level = 2
        levelIcon = "Profession level iron.png"
        levelName = "Œ©K‚¢"
    elseif level == "3" or level == "journeyman" or level == "gold" or level == "ˆêl‘O" then
        level = 3
        levelIcon = "Profession level gold.png"
        levelName = "ˆêl‘O"
    elseif level == "4" or level == "expert" or level == "emerald" or level == "n—ûŽÒ" or level == "n—û" then
        level = 4
        levelIcon = "Profession level emerald.png"
        levelName = "n—ûŽÒ"
    elseif level == "5" or level == "master" or level == "diamond" or level == "’Bl" then
        level = 5
